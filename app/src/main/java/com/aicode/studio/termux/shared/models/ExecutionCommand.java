package com.aicode.studio.termux.shared.models;
...
public class ExecutionCommand {
    ...
    */
    ...
    /**
     * The {@link ExecutionCommand} custom log level for background {@link com.aicode.studio.termux.shared.shell.TermuxTask}
     * commands. By default, @link com.aicode.studio.termux.shared.shell.StreamGobbler} only logs stdout and
     * stderr if {@link Logger} `CURRENT_LOG_LEVEL` is >= {@link Logger#LOG_LEVEL_VERBOSE} and
     * {@link com.aicode.studio.termux.shared.shell.TermuxTask} only logs stdin if `CURRENT_LOG_LEVEL` is >=
