package com.aicode.studio.termux.shared.termux;

import android.annotation.SuppressLint;

import com.aicode.studio.termux.shared.models.ResultConfig;
import com.aicode.studio.termux.shared.models.errors.Errno;
...
public final class TermuxConstants {
    ...
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.aicode.studio"; // Default: "com.aicode.studio"
    ...
    public static final String TERMUX_FDROID_PACKAGE_URL = FDROID_PACKAGES_BASE_URL + "/" + TERMUX_PACKAGE_NAME; // Default: "https://f-droid.org/en/packages/com.aicode.studio"


    /** Termux:API app name */
    public static final String TERMUX_API_APP_NAME = "Termux:API"; // Default: "Termux:API"
    /** Termux:API app package name */
    public static final String TERMUX_API_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".termux.api"; // Default: "com.aicode.studio.termux.api"
    ...
    public static final String TERMUX_BOOT_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".termux.boot"; // Default: "com.aicode.studio.termux.boot"
    ...
    public static final String TERMUX_BOOT_FDROID_PACKAGE_URL = FDROID_PACKAGES_BASE_URL + "/" + TERMUX_BOOT_PACKAGE_NAME; // Default: "https://f-droid.org/en/packages/com.aicode.studio.termux.boot"
    ...
    public static final String TERMUX_FLOAT_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".termux.window"; // Default: "com.aicode.studio.termux.window"
    ...
    public static final String TERMUX_FLOAT_FDROID_PACKAGE_URL = FDROID_PACKAGES_BASE_URL + "/" + TERMUX_FLOAT_PACKAGE_NAME; // Default: "https://f-droid.org/en/packages/com.aicode.studio.termux.window"
    ...
    public static final String TERMUX_STYLING_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".termux.styling"; // Default: "com.aicode.studio.termux.styling"
    ...
    public static final String TERMUX_STYLING_FDROID_PACKAGE_URL = FDROID_PACKAGES_BASE_URL + "/" + TERMUX_STYLING_PACKAGE_NAME; // Default: "https://f-droid.org/en/packages/com.aicode.studio.termux.styling"
    ...
    public static final String TERMUX_TASKER_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".termux.tasker"; // Default: "com.aicode.studio.termux.tasker"
    ...
    public static final String TERMUX_TASKER_FDROID_PACKAGE_URL = FDROID_PACKAGES_BASE_URL + "/" + TERMUX_TASKER_PACKAGE_NAME; // Default: "https://f-droid.org/en/packages/com.aicode.studio.termux.tasker"
    ...
    public static final String TERMUX_WIDGET_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".termux.widget"; // Default: "com.aicode.studio.termux.widget"
    ...
    public static final String TERMUX_WIDGET_FDROID_PACKAGE_URL = FDROID_PACKAGES_BASE_URL + "/" + TERMUX_WIDGET_PACKAGE_NAME; // Default: "https://f-droid.org/en/packages/com.aicode.studio.termux.widget"
    ...
    public static final String COMMA_ALTERNATIVE = "\u201a"; // Default: "\u201a" (U+201A single low-9 quotation mark)
    ...
    public static final class TERMUX_APP {
        ...
        public static final class TERMUX_SERVICE {
            ...
            /** Intent {@code String} extra for custom log level for background commands defined by {@link com.aicode.studio.termux.shared.logger.Logger} for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent */
        ...
        public static final class RUN_COMMAND_SERVICE {
            ...
            /** Intent {@code String} extra for custom log level for background commands defined by {@link com.aicode.studio.termux.shared.logger.Logger} for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
