...
import com.aicode.studio.termux.app.utils.PluginUtils;
import com.aicode.studio.termux.shared.data.IntentUtils;
import com.aicode.studio.termux.shared.models.errors.Errno;
import com.aicode.studio.termux.shared.shell.ShellUtils;
import com.aicode.studio.termux.shared.shell.TermuxShellEnvironmentClient;
import com.aicode.studio.termux.shared.shell.TermuxShellUtils;
...
import com.aicode.studio.termux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
import com.aicode.studio.termux.shared.settings.preferences.TermuxAppSharedPreferences;
import com.aicode.studio.termux.shared.shell.TermuxSession;
import com.aicode.studio.termux.shared.terminal.TermuxTerminalSessionClientBase;
import com.aicode.studio.termux.shared.logger.Logger;
import com.aicode.studio.termux.shared.notification.NotificationUtils;
...
import com.aicode.studio.termux.terminal.TerminalEmulator;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.aicode.studio.R.string.error_execution_cancelled))) {
