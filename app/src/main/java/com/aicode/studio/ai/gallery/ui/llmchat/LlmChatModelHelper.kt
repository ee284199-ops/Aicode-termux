...
package com.aicode.studio.ai.gallery.ui.llmchat

import android.content.Context
import android.graphics.Bitmap
import android.util.Log
import com.aicode.studio.ai.gallery.data.Accelerator
import com.aicode.studio.ai.gallery.data.ConfigKeys
import com.aicode.studio.ai.gallery.data.DEFAULT_MAX_TOKEN
import com.aicode.studio.ai.gallery.data.DEFAULT_TEMPERATURE
import com.aicode.studio.ai.gallery.data.DEFAULT_TOPK
import com.aicode.studio.ai.gallery.data.DEFAULT_TOPP
import com.aicode.studio.ai.gallery.data.DEFAULT_VISION_ACCELERATOR
import com.aicode.studio.ai.gallery.data.Model
import com.aicode.studio.ai.gallery.runtime.CleanUpListener
import com.aicode.studio.ai.gallery.runtime.LlmModelHelper
import com.aicode.studio.ai.gallery.runtime.ResultListener
...
object LlmChatModelHelper : LlmModelHelper {
  ...
  override fun initialize(
    ...
    val backendLabel = when (preferredBackend) {
        is Backend.GPU -> "GPU"
        is Backend.CPU -> "CPU"
        is Backend.NPU -> "NPU"
        else -> "AUTO"
    }
    Log.d(TAG, "Preferred backend: $backendLabel")
