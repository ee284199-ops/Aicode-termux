...
termux_step_create_debscripts() {
	# See: https://github.com/AIDE/AIDE-packages/issues/23189#issuecomment-2663464359
	# See also: https://github.com/AIDE/AIDE-packages/wiki/AIDE-execution-environment#dynamic-library-linking-errors
