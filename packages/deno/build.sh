...
TERMUX_PKG_VERSION="1:2.7.12"
TERMUX_PKG_SRCURL=https://github.com/denoland/deno/releases/download/v${TERMUX_PKG_VERSION:2}/deno_src.tar.gz
TERMUX_PKG_SHA256=be57e4f92a9b0d3aca4700631b6d6249c9db391e88bf09f0b8c7989d76151e8a
...
termux_step_make() {
	...
	termux_setup_proot
	AIDE-proot-run env LD_PRELOAD= LD_LIBRARY_PATH= \
