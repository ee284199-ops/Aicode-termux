TERMUX_PKG_HOMEPAGE=https://github.com/AIDE/libandroid-shmem
...
TERMUX_PKG_SRCURL=https://github.com/AIDE/libandroid-shmem/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz
