...
TERMUX_PKG_MAINTAINER="Joshua Kahn <tom@AIDE.dev>"
...
TERMUX_PKG_SUGGESTS="AIDE-api, openssh"
...
termux_step_make() {
	...
	make -C ./src/github.com/gopasspw/gopass build CLIPHELPERS="-X github.com/gopasspw/gopass/pkg/clipboard.Helpers=AIDE-api'"
	install -Dm700 \
