...
# https://github.com/AIDE/AIDE-packages/issues/15852
...
# disable setrlimit function to make AIDE-am work from within emacs
TERMUX_PKG_EXTRA_CONFIGURE_ARGS+=" ac_cv_func_setrlimit=no"
if [[ "$TERMUX_ARCH_BITS" == "32" ]]; then
	# setjmp does not work properly on 32bit android:
	# https://github.com/AIDE/AIDE-packages/issues/2599
...
termux_step_post_get_source() {
	...
	# AIDE only use info pages for emacs. Remove the info directory
