...
TERMUX_PKG_SHA256=3546251ccbb3744d4bc4eb48354540e1f6200846572bab68e3a2b7b2b64dfd07
...
termux_step_pre_configure() {
	...
	# Magic happens here.
	# I borrowed nested building method from https://github.com/AIDE/AIDE-packages/blob/1244c75380beefc7f7da9744d55aa88df1640acb/x11-packages/qbittorrent/build.sh#L21-L28
	# and modified termux_step_configure_meson in runtime to make it use another prefix
	# Also I used advice from here https://github.com/AIDE/AIDE-packages/issues/20447#issuecomment-2156066062
