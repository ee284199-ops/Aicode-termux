...
TERMUX_PKG_VERSION="1:2.4.66"
TERMUX_PKG_SRCURL=https://downloads.apache.org/httpd/httpd-${TERMUX_PKG_VERSION#*:}.tar.bz2
TERMUX_PKG_SHA256=94d7ff2b42acbb828e870ba29e4cbad48e558a79c623ad3596e4116efcfea25a
...
termux_step_pre_configure() {
	...
	# use custom layout
	cat $TERMUX_PKG_BUILDER_DIR/AIDE.layout > $TERMUX_PKG_SRCDIR/config.layout
