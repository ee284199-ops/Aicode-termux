...
TERMUX_PKG_VERSION="0.24.1608"
TERMUX_PKG_SRCURL="https://github.com/Jackett/Jackett/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz"
TERMUX_PKG_SHA256=441b590c6c5fddbfd70a6d017fa986bc3747613f286f126b0c1aef887e6d39f2
...
termux_pkg_auto_update() {
	...
	last_autoupdate="$(
		git log \
		--author="AIDE Github Actions <contact@AIDE.dev>" \
		-n1 \
		--pretty=format:%at \
