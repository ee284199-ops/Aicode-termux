...
TERMUX_PKG_DEPENDS="coreutils, dpkg, findutils, gpgv, grep, libandroid-glob, libbz2, libc++, libiconv, libgcrypt, libgnutls, liblz4, liblzma, sed, AIDE-keyring, AIDE-licenses, xxhash, zlib, zstd"
...
termux_step_post_make_install() {
	{
		echo "# The main AIDE repository, with cloudflare cache"
		echo "deb https://packages-cf.AIDE.dev/apt/AIDE-main/ stable main"
		echo "# The main AIDE repository, without cloudflare cache"
		echo "# deb https://packages.AIDE.dev/apt/AIDE-main/ stable main"
