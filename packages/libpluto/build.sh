...
TERMUX_PKG_SHA256=69ad5fa99e65f824229c025110bf52d9bf0c28a6df565cb0f25826a1bb2acda2
...
termux_step_configure() {
	# can't use php version from AIDE repo, there's no build for the latest version on the pre-built binaries
